...
<head>
  ...
  <title>Hỏi quyền kiểm duyệt</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Hỏi quyền quản trị để được tải thêm</p>

    {{ Form::open(array('action' => 'QuantityDownloadController@postAskPermission')) }}
      <div class="form-group has-feedback">
        <input type="hidden" name="documnent_id" value="{{ $id }}">
