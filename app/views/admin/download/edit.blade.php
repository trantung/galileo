...
<div class="box-body col-sm-6">
    <div class="form-group well well-sm">
        <div class="input-group inline-block">
            ...
            {{ Form::text('max_account', Input::get('max_account'), Input::get('max_account'), array('class' => 'form-control' )) }}
        </div>
        <div class="input-group inline-block">
            <label for="max_document">Số lượt tải/tài liệu</label>
            {{ Form::text('max_document', Input::get('max_document'), Input::get('max_document'), array('class' => 'form-control')) }}
        </div>
        ...
        <div class="input-group inline-block col-sm-5" >
            ...
            {{ Form::date('start_time', Input::get('start_time'), Input::get('start_time'), array('class' => 'form-control')) }}
        </div>
        <div class="input-group inline-block col-sm-5" >
