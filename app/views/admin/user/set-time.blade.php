                ...
                <fieldset class="form-group col-sm-4">
                    <div class="well well-sm">
                        ...
                        <div class="inline-block">
                            <label>Bắt đầu:</label>
                            <input class="inline-block" type="time" name="time[{{ T2 }}][][start]" value="{{ $value2->start_time }}" placeholder="" min="6:00" max="21:00">
                        </div>
                        <div class="inline-block">
                            <label>Kết thúc:</label>
                            <input class="inline-block" type="time" name="time[{{ T2 }}][][end]" value="{{ $value2->end_time }}" placeholder="" min="6:00" max="21:00">
                        </div>
                        @endforeach
                        <hr/>
                        <div class="inline-block">
