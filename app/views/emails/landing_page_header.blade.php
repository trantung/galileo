...
?>
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-top: 40px;padding-bottom: 35px;background:{{ url($urlBg) }} ">
    <tbody>
    <tr><td><div  style="margin:0 auto;max-width:670px;width:100%;background:{{ url($urlBgTop) }} no-repeat #fff;height:10px;"></div></td></tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <table style="width:100%;max-width:713px;border-collapse:collapse;margin:0 auto;text-align: center;line-height: 32px;font-family: Arial, sans-serif;font-weight: bold">
                    ...
                    <tr>
                        <td width="22" style="padding:0"><div style="width:22px;height:62px;background: {{ url($urlBorderLeft) }}"></div></td>
                        ...
                        <td width="22" style="padding:0"><div style="width:22px;height:62px;background:{{ url($urlBorderRight) }}"></div></td>
                    </tr>
                </table>
            </td>                  
        </tr>
