            ...
            ?>
                ...
                <td>
                    ...
                    <tr>
                        <td>
                            <table style="width:100%;max-width:670px;border-collapse: collapse;background:url('http://cloud.galileo.edu.vn/image_landing/email/border-bottom-email.png') no-repeat #0072bc;margin:0 auto;">
                                <tr>
