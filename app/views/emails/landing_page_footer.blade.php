                                ...
                                <tr>
                                    ...
                                    <td width="40" style="text-align: center;">
                                        <a href="{{ $urlFacebook }}" target="_blank">
                                            <img src="/image_landing/email/social-facebook.png" alt="Facebook" style="display: inline-block;" border="0" />
                                        </a>
                                    </td>
                                    <td width="40" style="text-align: center;">
                                    ...
                                    <td width="40" style="text-align: center;">
                                        <a href="https://hocmai.vn/ho-tro/" target="_blank">
                                            <img src="/image_landing/email/help2.png" alt="Help" style="display: inline-block;" border="0" />
                                        </a>
                                    </td>
                                    <td width="140"></td>
                                </tr>
