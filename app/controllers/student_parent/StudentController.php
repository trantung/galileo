...
class StudentController extends BaseController {
    ...
    {   // create backage
        $package = Package::all();                            // $package = Package::all();
        $class = ClassModel::lists('name', 'id');             // $class = ClassModel::lists('name', 'id');
        $subject = Subject::lists('name', 'id');              // $subject = Subject::lists('name', 'id');
        $level = Level::lists('name', 'id');                  // $lever = Lever::lists('name', 'id');
        $center = Center::lists('name', 'id');                // $center = Center::lists('name', 'id')''
